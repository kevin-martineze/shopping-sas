<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			...
			// Un peldaño más alto que el shadcn de fábrica en toda la escala: se
			// probó y los botones de 32px (el `default` original) se sentían
			// chicos, sobre todo en el celular. `Input` y el disparador de
			// `Select` subieron con la misma medida, para que un campo y su
			// botón seguido no se descuadren en altura.
			size: {
